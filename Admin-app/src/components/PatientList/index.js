...
const rows = [
  ...
  <span class="label-positive">positive</span>, "23/05/22", "Allyson Richards", <FlagIcon className={flag ? "priority-flag clicked" : "priority-flag"}></FlagIcon>, "90°C", "150 lbs", "5'9"),
